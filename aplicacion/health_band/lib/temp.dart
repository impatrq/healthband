      ...
      appBar: AppBar(
        ...
        flexibleSpace: Container(
          ...
          decoration: const BoxDecoration(
            ...
            image: DecorationImage(image:AssetImage('/Users/tobiaspagano/Documents/GitHub/healthband/aplicacion/health_band/lib/assets/images/termometro pattern.png'), opacity: 0.1, fit: BoxFit.fill )
          ),
        ),
        title: Text('Temperatura Corporal', style: TextStyle(color: Colors.white, fontSize: 30, fontWeight: FontWeight.w300),),
      ) ,
     body: Center(
       child: Container(
          ...
          child: Column(
            children: [
              SizedBox(height: 20),
              Text('37 C', style: TextStyle(fontSize: 100, fontWeight: FontWeight.w700, color: Colors.black),),
              SizedBox(height: 35,),
              Stack(
              children: <Widget>[
                AspectRatio(
